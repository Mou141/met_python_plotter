...
class METDataPoint:
    ...
    def get_mountain_area_capabilities(self) -> list[MountainForecastCapabilities]:
        """Gets information on the currently available mountain area forecasts."""
        r = self._session.get(
            f"{self.base_url}txt/wxfcs/mountainarea/json/capabilities",
            params={"key": self.key},
        )
